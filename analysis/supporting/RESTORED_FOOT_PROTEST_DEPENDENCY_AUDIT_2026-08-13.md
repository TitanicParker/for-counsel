...
```mermaid
flowchart TD
    A["10 Jul encounter — stipulated"] --> B["Completed discharge — protest omitted"]
    B --> C["Longitudinal clinical record"]
    C --> D["March 2025 rebuttal"]
    B --> D
    D --> E["Medical Council / QPS materials"]
    E --> F["PAR and SIMT outcome"]
    F --> G["2026 QPS continued reliance"]
```
