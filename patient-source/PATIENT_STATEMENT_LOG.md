...
**Status:** ongoing first-person source log  
**Source origin:** Liam Moloney  
**Purpose:** preserve patient-origin evidence supplied over time without forcing it immediately into the case theory, proposition map, or public narrative.

## Governing rule

This is a **source log**, not an analytical document.

Entries should preserve Liam's own account as closely as possible and should not be silently harmonised with the institutional record or later case theory.

The repository should consult this log only where patient evidence is materially relevant. The case remains document-led.

Patient voice is especially relevant to:

- the order of events Liam personally experienced;
- what clinicians directly said to him;
- what he said in response;
- the reported bedside protest;
- who was present at encounters Liam personally witnessed;
- what he meant by his own recorded distinctions;
- the Podiatry treatment he actually received;
- what treatment effects he personally experienced where the records do not fully capture them.

The log should **not** be used merely to duplicate facts better established by contemporaneous records.

---

# Entry protocol

Each new entry should use the following structure.

## PSL-XXXX — [short subject]

**Statement date:** YYYY-MM-DD  
**Historical period/event described:** [date/range if known]  
**Statement type:** recollection / clarification of meaning / direct communication / treatment received / symptom experience / other  
**Prompt context:** [briefly record what caused Liam to add the statement; avoid argumentative framing]  

### Liam's statement

> Preserve Liam's wording here as closely as practicable.

### Source-status note

State what the entry can prove directly. For example:

- direct evidence of what Liam remembers seeing/hearing/doing;
- direct evidence of what Liam says he meant by his own earlier words;
- direct evidence of treatment he remembers receiving;
- not direct evidence of what another person privately thought or intended.

### Potential corroboration / contradiction routes

List only concrete routes, such as:

- contemporaneous clinical record;
- Complex Case Meeting material;
- four medical student witnesses;
- Podiatry record;
- GP record;
- correspondence;
- medication record;
- family/witness evidence where genuinely relevant.

### Analytical status

`UNASSESSED` by default.

An entry does not change a proposition merely by being logged. It should first be compared with the documentary record and any independent evidential origins.

---

# Current priority subjects

The current case architecture identifies four areas in which patient-origin evidence is particularly useful and proportionate:

1. **Tuesday 4 July 2017 — order of events**
   - movement from ward/bed;
   - attendance at the Complex Case Meeting if remembered;
   - examination there;
   - sequence leading to communication of the levodopa decision.

2. **What the neurologist directly said to Liam**
   - explanation of diagnosis;
   - explanation for levodopa deferral;
   - any reference to senior authority / `the boss`;
   - what was said about the feet and their relationship to the neurological problem;
   - what Liam understood would happen next.

3. **The bedside protest**
   - location;
   - trigger;
   - what Liam objected to;
   - what he said;
   - clinician response;
   - four medical students present;
   - immediate consequence.

4. **Podiatry treatment actually received**
   - where and when;
   - what treatment was performed;
   - what parts of the feet were treated;
   - explanation given;
   - benefit / no effect / worsening;
   - what Liam reported back;
   - how the Podiatry pathway ended.

The meaning of the recorded 2017 distinction between foot pain and leg tension may be captured within the relevant entry if Liam wishes to clarify it.
